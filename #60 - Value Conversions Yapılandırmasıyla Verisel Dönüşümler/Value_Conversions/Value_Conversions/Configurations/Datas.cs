...
namespace Value_Conversions.Configurations
{
    public class PersonData : IEntityTypeConfiguration<Person>
    {
        ...
        {
            builder.HasData(
                     new() { Id = 1, Name = "Ayşe", Gender = "F", Gender2 = Gender.Female, Married = true },
                     new() { Id = 2, Name = "Hilmi", Gender = "M", Gender2 = Gender.Male, Married = false },
                     new() { Id = 3, Name = "Raziye", Gender = "F", Gender2 = Gender.Female, Married = true },
                     new() { Id = 4, Name = "Süleyman", Gender = "M", Gender2 = Gender.Male, Married = false },
                     new() { Id = 5, Name = "Fadime", Gender = "F", Gender2 = Gender.Female, Married = true },
                     new() { Id = 6, Name = "Şuayip", Gender = "M", Gender2 = Gender.Male, Married = true },
                     new() { Id = 7, Name = "Lale", Gender = "F", Gender2 = Gender.Female, Married = false },
                     new() { Id = 8, Name = "Jale", Gender = "F", Gender2 = Gender.Female, Married = true },
